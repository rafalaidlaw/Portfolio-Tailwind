...
const MatrixRainingCodeOrange = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      // Create a translucent orange overlay to create the fading effect
      ctx.fillStyle = "rgba(124, 45, 18, 0.347)";
      ctx.fillRect(0, 0, width, height);

      // Orange color for characters
      ctx.fillStyle = "#ba3f00";
...
export default MatrixRainingCodeOrange; 