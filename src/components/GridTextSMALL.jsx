                                              ...
                                              <div className="border-b-2 border-orange-300 ">
                                                <div className="flex justify-center ">
                                                  <div className="bg-orange-400 grid grid-flow-row ">
                                                    <h1 className="text-6xl text-center font-Caprasimo tracking-wider text-orange-500 drop-shadow-glow scale-y-90">
                                                      Internet Banner Ads
                                                    </h1>
                                                    <p className="text-lg text-center  font- text-orange-200  tracking-wider py-1 scale-y-90"></p>
                                                    <div>
