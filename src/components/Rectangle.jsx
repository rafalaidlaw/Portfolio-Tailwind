...
export const Rectangle = () => {
  return (
    <div className="opacity- sm:hidden md:block">
      ...
      <div className="opacity-50 absolute top-56 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-amber-400 mix-blend-overlay filter blur-3xl"></div>
