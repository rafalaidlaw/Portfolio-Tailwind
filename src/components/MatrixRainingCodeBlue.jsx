...
const MatrixRainingCodeBlue = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      // Create a translucent blue overlay to create the fading effect
      ctx.fillStyle = "rgba(30, 58, 138, 0.347)";
...
export default MatrixRainingCodeBlue; 